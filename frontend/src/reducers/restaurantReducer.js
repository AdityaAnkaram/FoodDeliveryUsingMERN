import { ALL_RESTAURANTS_REQUEST,ALL_RESTAURANTS_SUCCESS,ALL_RESTAURANTS_FAIL,CLEAR_ERRORS, TOGGLE_VEG_ONLY, SORT_BY_RATINGS, SORT_BY_REVIEWS } from "../constants/restaurantConstant";
const initialState={
    restaurant:[],
}

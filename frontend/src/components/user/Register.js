  ...
  return (
    ...
    <div className='col-10 col-lg-5 registration-form'>
        ...
        >
            ...
            <div className='form-group'>
            <label htmlFor="passwordConfirm_field">Password Confrim</label>
            ...
            <input type="number" id="phoneNumber_field" className='form-control'
            ...
            className='btn btn-block py-3'>REGISTER</button>
        </form>
    </div>
    </div>
    </>
